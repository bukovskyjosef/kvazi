...
| `operations/production-release.md` | provoz, vývojář, reviewer | ne | GitHub/Coolify release, secrets contract, infra handoff a production acceptance | technický provozní kontrakt podřízený pravidlům a architektuře; skutečný stav nasazení a evidence jsou v GitHub Issues |
