...
<main class="container-sm page-body">
  ...
  <div class="manifest-body">
    ...
    <p>Měli bychom občas víc <strong>zapojit vlastní hlavu</strong>, víc si hrát, vymýšlet, diskutovat a zkoušet něco vyřešit jenom tím, co sami umíme a víme. Ne všechno přece musí být dohledatelné, změřitelné a okamžitě ověřitelné na internetu.</p>
    <p>Právě proto vznikla tahle <span class="kq">kvazisoutěž</span>.</p>
    <p>Nabízí problém, který by měl být v zásadě řešitelný skoro pro každého, kdo mluví česky a prošel základní školou. Možná si občas budete potřebovat ověřit nějaké pravidlo nebo holý fakt, ale samotná práce na <span class="kq">kvazivětě</span> by měla být hlavně na vás.</p>
    ...
    <p>A to je vlastně hlavní smysl celé věci: na chvíli se zastavit, odložit techniku a něco společně vymýšlet. Klidně s knihou po ruce, ale hlavně s <strong>vlastní hlavou</strong>.</p>
  ...
  <div class="manifest-body" style="margin-top:48px">
    ...
    <p>
      Nejdelší <span class="kq">kvazivěta</span> stojí na průniku jazyka, logiky a vynalézavosti.
      Omezená zásoba znaků nutí hráče přemýšlet o morfologii češtiny způsobem,
      který slovníky ani učebnice nenabídnou.
    </p>
    <p>
      <span class="kq">Kvazislova</span> — slova, která hráč vymyslí — nejsou únik, ale výzva:
      musíš je zařadit do gramatického modelu, obhájit jejich tvar a dokázat,
      že v české větě dávají smysl.
    </p>
    <p style="margin-top:20px">
      Autorem <span class="kq">kvaziproblému</span> a pravidel je <strong style="color:var(--text)">Josef Bukovský</strong>.
    </p>
    <p style="margin-top:20px">
