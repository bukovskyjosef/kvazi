...
<main class="container page-body">
  ...
  <section class="spec-section" id="s13">
    ...
    <div class="spec-block">Každá zveřejněná <code>rules_version</code> má neměnný manifest normativního balíku a hashů jeho součástí. Čistě redakční změna bez dopadu na soutěžní význam novou verzi nevyžaduje; změna pravidla nebo autoritativního výkladu, která může změnit verdict, ano. Spravovaný katalog skutečných slov je provozní lexikální autorita mimo immutable manifest rules verze a jeho běžná oprava sama novou rules verzi nevyžaduje.</div>
    <div class="spec-block">Každé odeslání vytváří neměnnou revizi podání. Novější rules verze může stejnou revizi znovu posoudit a vytvořit nový validační výsledek, ale nepřepisuje historický verdikt ani historické skóre. Procesní compliance původního podání se při obsahové revalidaci zpětně nepřepisuje. Aktuální žebříček používá aktuální rules verzi, historické výsledky zůstávají zachovány.</div>
    <div class="spec-block">Interní morfologická review cache je scoped na rules verzi; nová verze automaticky nepřebírá starší schválení. Spravovaný katalog skutečných slov se naopak novou rules verzí nevynuluje. Historická validace musí mít dostatečnou provenance k dohledání rozhodujících pravidel, validátoru, review-cache znalosti a relevantní katalogové revize.</div>
  </section>
